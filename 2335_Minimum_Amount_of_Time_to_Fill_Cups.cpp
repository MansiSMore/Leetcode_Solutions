...
*/
/*
Logic is if addition of two elements is less than or equal to maximum no of amount, then just return max no, else calculate the sum of all elements and if 
that sum is odd then divide it by 2 and add 1 to it, else return sum / 2.
*/
class Solution {
public:
